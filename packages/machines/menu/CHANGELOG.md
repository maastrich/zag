...
- [#1431](https://github.com/chakra-ui/zag/pull/1431) [`80b97a9`](https://github.com/chakra-ui/zag/commit/80b97a907382f0cece781abeae2a462f9bfba686) Thanks [@segunadebayo](https://github.com/segunadebayo)! - Focus first tabbable element when menu opens. To allow composition with combobox
...
- [`492d152`](https://github.com/chakra-ui/zag/commit/492d152c04ab367e6c4fd80b1a1f1a68bb287e46) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Expose `onEscapeKeyDown` event handler
...
- [`2a024fb`](https://github.com/chakra-ui/zag/commit/2a024fbd2e98343218d4d658e91f1d8c751e1a4d) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - - Rename `GroupProps` to `ItemGroupProps`
...
- Updated dependencies []:
  ...
  - @zag-js/rect-utils@0.31.1

## 0.31.0

### Patch Changes

- [`c0cd20bc`](https://github.com/chakra-ui/zag/commit/c0cd20bc1a5a14d3cead677f7ddb0723d7562989) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Fix issue in non-portalled, nested menus where keyboard
  interactions within submenu bubble to parent menu
...
- [`360176d9`](https://github.com/chakra-ui/zag/commit/360176d9db4468802c2172acdfb6c8529d2393e5) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Fix issue where menu does not scroll highlighted item into view
...
- [`063bbc40`](https://github.com/chakra-ui/zag/commit/063bbc40a2674049a343226a42af2ed1d2b7e884) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Support the use of `Tab` key press to navigate through the menu
  items.

- [#451](https://github.com/chakra-ui/zag/pull/451)
  [`3d1f2ca3`](https://github.com/chakra-ui/zag/commit/3d1f2ca300bbfe78c3b8d474d258d912b92e6b52) Thanks
  [@anubra266](https://github.com/anubra266)! - Refactor `onSelect`
...
- [`34553da4`](https://github.com/chakra-ui/zag/commit/34553da48370383d14d683e9d28f3e0e7ffb6165) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Add support for `onOpen` and `onClose` callbacks

### Patch Changes

- [#405](https://github.com/chakra-ui/zag/pull/405)
  [`19bdcdf0`](https://github.com/chakra-ui/zag/commit/19bdcdf0b2a6f93119c7e3ce9d798a837a68513a) Thanks
  [@anubra266](https://github.com/anubra266)! - Change `activeId` to `highlightedId`
...
- [`f1ed3f47`](https://github.com/chakra-ui/zag/commit/f1ed3f47816336271e125938ebb37b296aa694ee) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Fix issue where using a button element for the menuitem doesn't
  work as expected.
...
- [`6399a7f2`](https://github.com/chakra-ui/zag/commit/6399a7f2bbb4b1926288652665d362a1fabc9714) Thanks
  [@segunadebayo](https://github.com/segunadebayo)! - Fix issue where menu triggers onclick twice when closeOnSelect is
  set to false
